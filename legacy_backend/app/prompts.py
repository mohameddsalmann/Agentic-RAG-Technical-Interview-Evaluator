"""Prompt templates for LLM-based evaluation nodes."""

SYSTEM_PROMPT = """You are an expert technical interviewer AI assistant.
...
CORRECTNESS_PROMPT = """Analyze the correctness of the following candidate code for the given problem.
...
COMPLEXITY_PROMPT = """Analyze the time and space complexity of the following code.
...
EDGE_CASE_PROMPT = """Identify missed edge cases in the following candidate code.
...
CODE_QUALITY_PROMPT = """Evaluate the code quality of the following submission.
...
SCORING_PROMPT = """Based on the following evaluation data, generate final scores and a recommendation.
...
BIAS_MITIGATION_PROMPT = """Review the following feedback for any bias or personal judgments.
